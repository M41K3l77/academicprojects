...
/**
 * Servlet implementation class MeneameHomeMenearServlet
 */
@WebServlet(
		name="MeneameHomeMenearServlet",
		urlPatterns={"/MeneameHomeMenearServlet"})
public class MeneameHomeMenearServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MeneameHomeMenearServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		newsDao.save(news);
		response.sendRedirect("MeneameHomeMenearServlet");
	}
