...
<body class="body">
	...
	<main class="centralsectionloginregister">
		...
		<div class="loginsection">
			...
			<form class="loginuser" method="POST" enctype="application/x-www-form-urlencoded" action="LoginServlet">
				...
				<label class="password">
					password<input type="password" name="userpassword" placeholder="***************" maxlength="40" required>
				</label>
