...
<body class="body">
	...
	<main class="centralsectionenviarcomentario">
		...
		<div class="enviarcomentariosection">
			...
			<form class="enviarcomentario" action="EditarComentarioServlet" method="POST">
				Comentario
 				<input type="hidden" name="commentid" value="${commentid}">
				<textarea class="comentariouser" rows="8" cols="50" maxlength="400" name="usercomment" value="${usercomment}" placeholder="inserta tu comentario" required>${textcomment}</textarea>
